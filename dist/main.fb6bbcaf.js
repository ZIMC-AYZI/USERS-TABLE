...
(0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee6() {
  "use strict"; //DOM section

  var tableBody, addBtn, newUserForm, users, getUsers, _getUsers, removeUser, _removeUser, getRenderedTableBody, getUserInModal, createUser, _createUser, getFromData, showModal, sortBy, direction;

  return _regenerator.default.wrap(function _callee6$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          sortBy = function _sortBy(users, propertyForSort) {
          ...
          showModal = function _showModal(container) {
            ...
            var closeForm = document.querySelector(".save").addEventListener("click", function () {
            ...
            var modalWidth = modal.offsetWidth / 2;
            var modalHeight = modal.offsetHeight / 2;
            modal.style.left = "calc(50% - ".concat(modalWidth, "px)");
            modal.style.top = "calc(50vh - ".concat(modalHeight, "px)");
          ...
          getFromData = function _getFromData(form) {
            ...
            formData.forEach(function (item) {
              if (item[0].indexOf(".") === -1) {
                ...
                resObject[props[0]] = (0, _defineProperty2.default)({}, props[1], item[1]);
              }
            });
            return resObject;
          };
          ...
          _createUser = function _createUser3() {
            _createUser = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee5(user) {
          ...
          createUser = function _createUser2(_x4) {
            return _createUser.apply(this, arguments);
          };

          getUserInModal = function _getUserInModal(user) {
            return "\n    <div>city : ".concat(user.address.city, "</div>\n    <div>street : ").concat(user.address.street, "</div>\n    <div>zipcode : ").concat(user.address.zipcode, "</div>\n    ");
          };

          getRenderedTableBody = function _getRenderedTableBody(users) {
            return users.reduce(function (html, _ref4) {
              var id = _ref4.id,
                  name = _ref4.name,
                  username = _ref4.username,
                  email = _ref4.email,
                  website = _ref4.website;
              return html + "\n    <tr class=\"user-name\" data-uid=\"".concat(id, "\">\n      <td>").concat(name, "</td>\n      <td>").concat(username, "</td>\n      <td>").concat(email, "</td>\n      <td>").concat(website, "</td>\n      <td><button data-uid=\"").concat(id, "\" class =\"remove-btn\">Remove</button></td>\n    </tr>\n    ");
            }, "");
          };

          _removeUser = function _removeUser3() {
            _removeUser = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee4(id) {
          ...
          removeUser = function _removeUser2(_x3) {
            return _removeUser.apply(this, arguments);
          };

          _getUsers = function _getUsers3() {
          ...
          getUsers = function _getUsers2() {
            return _getUsers.apply(this, arguments);
          };

          tableBody = document.getElementById("table-body");
          addBtn = document.querySelector(".add-user");
          newUserForm = document.querySelector(".add-user-form"); //Data section
        ...
        case 16:
          ...
          console.log(users); //EVENT SECTION
          //AddUser
          ...
          tableBody.addEventListener("click", /*#__PURE__*/function () {
            var _ref3 = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee2(e) {
              var currentElement, userId, user, _userId, userIndex, answer;
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      ...
                      userId = +currentElement.getAttribute("data-uid");
                    ...
                    case 7:
                      ...
                      _userId = +e.target.getAttribute("data-uid");
                      userIndex = users.findIndex(function (user) {
          ...
          //Main
          tableBody.innerHTML = getRenderedTableBody(users); //RenderingUsers

          direction = "asc"; //sortbyName
          ...
          document.querySelector(".sort-email").addEventListener("click", function () {
            users = sortBy(users, "email", direction);
            tableBody.innerHTML = getRenderedTableBody(users);
            direction = direction === "asc" ? "desc" : "asc";
          }); //sortByNickname

          document.querySelector(".sort-username").addEventListener("click", function () {
            users = sortBy(users, "username", direction);
            tableBody.innerHTML = getRenderedTableBody(users);
            direction = direction === "asc" ? "desc" : "asc";
          }); //sortByWebsite

          document.querySelector(".sort-website").addEventListener("click", function () {
